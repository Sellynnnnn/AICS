...
<head>
  ...
  <title> AICS BATANGAS: Computer Laboratory Attendance Monitoring and Profiling System</title>
    ...
    <div class="row">
      <div class="col-xs-12">
        <h4 class="page-header ">
          <i class="fa fa"></i> AICS BATANGAS: Computer Laboratory Attendance Monitoring and Profiling System
